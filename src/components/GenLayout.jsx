...
import classroomsIcon from "../assets/icons/classroomsIcon.svg";
import studentsIcon from "../assets/icons/studentsIcon.svg";
import subjectsIcon from "../assets/icons/subjectsIcon.svg";
import scoresheetIcon from "../assets/icons/scoresheetIcon.svg";
import schoolCalenderIcon from "../assets/icons/schoolCalenderIcon.svg";
          ...
          <div className="sticky top-0 z-40 flex h-[50px] shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:pl-5 lg:pr-2">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 justify-between items-center">
              ...
              <div className="flex items-center justify-center gap-[6px]">
                <p className="text-[10px] hidden md:block text-[#403294] font-semibold">
                  First Term 2020/2021 Session
                </p>
                <img
                  src={ShortDownArrowIcon2}
                  alt="down arrow"
                  className="w-[7px] h-[7px] hidden md:block"
                />
              </div>
